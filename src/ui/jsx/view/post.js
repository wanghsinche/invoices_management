                ...
                <form className="grid grid-pad">
                    ...
                    <div className="col-1-1">
                        <div className="form-actions" style={{ 'textAlign': 'right' }}>
                            <Button type="submit" ptStyle="btn-default  btn-large" text="clear" onClick={this.handleClear.bind(this)} />
                            <Button type="submit" ptStyle="btn-primary  btn-large" text="Submit" onClick={this.handleClick.bind(this)} />
                        </div>
                    </div>
                </form>
            </Pane>
